...
4. **팝업 설정**: API 엔드포인트 주소·API Key·자동 스캔 토글을 설정하고, 확장 팝업을 열 때마다 **최근 검사 결과**(신뢰도·판정 요약)를 확인합니다.
...
5. ChatGPT/Claude/Gemini/AI Studio 에서 역사 질문 후 답변에 Truth History 배지가 나타나는지 확인.
